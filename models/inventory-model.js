...
/*Function to insetrt in Database*/
...
/* ***************************
 *  Get vehicles for Request by classification_id
 * ************************** */
async function getRequestByClassificationId(classification_id) {
  try {
    const data = await pool.query(
      `SELECT * FROM public.inventory AS i 
      JOIN public.classification AS c 
    ...
    console.error("getRequestByClassificationId error " + error)
  }
}
